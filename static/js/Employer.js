...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Create Job Modal
    document.getElementById('create-job-modal').addEventListener('click', () => {
        Swal.fire({
            title: 'Create Job Post',
            html: `
                <input type="text" id="job-title" class="swal2-input" placeholder="Job Title">
                <input type="text" id="job-location" class="swal2-input" placeholder="Location">
            `,
            ...
            if (result.isConfirmed) {
                console.log('Job Created:', result.value);
            }
        });
    });

    // Hiring Chart
    const ctx = document.getElementById('hiring-chart').getContext('2d');
    new Chart(ctx, {
        type: 'bar',
        data: {
    ...
    // Example usage
    showNotification('New application received: Sarah Johnson');
